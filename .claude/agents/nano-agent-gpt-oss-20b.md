...
description: "Executor agent for well-scoped coding tasks. Runs locally on gpt-oss:20b (Ollama, 14GB). Free. Best for single-file implementations with clear specs. Claude Code plans, this agent executes."
model: haiku
color: blue
tools: mcp__nano-agent__prompt_nano_agent
---

# Nano Agent Executor — GPT-OSS 20B
